...
This project is an implementation of bignum - an arbitrary precision
integer. Currently it supports addition and multiplication of arbitrary
...
Running make produces a library libmsbignum.so in the build directory as
